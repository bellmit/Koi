...
import co.casterlabs.koi.user.trovo.user.TrovoAppAuth;
import co.casterlabs.koi.user.trovo.user.TrovoProvider;
import co.casterlabs.koi.user.trovo.user.TrovoUserAuth;
import co.casterlabs.koi.user.trovo.user.TrovoUserConverter;
